...
-- Ember is work-only and intentionally disabled on the personal machine.
-- jdtls is managed by the nvim-jdtls plugin.
vim.lsp.enable({ "vtsls", "lua_ls", "astro", "svelte" })
