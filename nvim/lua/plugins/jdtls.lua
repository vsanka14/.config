...
return {
  ...
  config = function()
    ...
    vim.api.nvim_create_user_command("JdtlsCleanWorkspace", function()
      ...
      vim.wait(1000, function() return #vim.lsp.get_clients({ name = "jdtls" }) == 0 end)

      vim.fn.delete(workspace, "rf")
      vim.notify("Cleaned workspace: " .. project_name .. "\nReopen a java file to reimport.", vim.log.levels.INFO)
