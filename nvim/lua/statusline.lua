...
-- ============================================================================
local mode_map = {
  n = "NORMAL", no = "OP-PENDING", nov = "OP-PENDING", noV = "OP-PENDING", ["no\22"] = "OP-PENDING",
  niI = "NORMAL", niR = "NORMAL", niV = "NORMAL", nt = "NORMAL",
  v = "VISUAL", vs = "VISUAL", V = "VISUAL LINE", Vs = "VISUAL LINE",
  ["\22"] = "VISUAL BLOCK", ["\22s"] = "VISUAL BLOCK",
  s = "SELECT", S = "SELECT LINE", ["\19"] = "SELECT BLOCK",
  i = "INSERT", ic = "INSERT", ix = "INSERT",
  R = "REPLACE", Rc = "REPLACE", Rx = "REPLACE",
  Rv = "VISUAL REPLACE", Rvc = "VISUAL REPLACE", Rvx = "VISUAL REPLACE",
...
local mode_hl = {
  NORMAL = "Mode", INSERT = "ModeInsert",
  VISUAL = "ModeVisual", ["VISUAL LINE"] = "ModeVisual", ["VISUAL BLOCK"] = "ModeVisual",
  SELECT = "ModeVisual", ["SELECT LINE"] = "ModeVisual", ["SELECT BLOCK"] = "ModeVisual",
  REPLACE = "ModeReplace", ["VISUAL REPLACE"] = "ModeReplace",
  COMMAND = "ModeCommand", TERMINAL = "ModeTerm",
}
...
local function update_git_branch()
  ...
  if dir == "" then cache.git_branch = ""; return end
...
local function update_lsp_progress(args)
  ...
  if not val or not id then return end
  ...
  local msgs = {}
  for _, msg in pairs(lsp_progress_map) do msgs[#msgs + 1] = msg end
